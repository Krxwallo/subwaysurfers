...
public abstract class StructureTemplateMixin implements ClientStructureTemplate {
    ...
    @Shadow
    protected abstract void spawnEntities(ServerWorldAccess serverWorldAccess, BlockPos blockPos, BlockMirror blockMirror, BlockRotation blockRotation, BlockPos blockPos2, @Nullable BlockBox blockBox, boolean bl);
